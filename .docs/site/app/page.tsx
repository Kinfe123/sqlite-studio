...
const description = "Single binary, single command SQL database explorer. Supports SQLite, libSQL, PostgreSQL, MySQL, DuckDB, ClickHouse, Microsoft SQL Server, Parquet, and CSV.";
